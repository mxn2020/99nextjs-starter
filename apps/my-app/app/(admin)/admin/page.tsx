...
// import { getAdminClient } from '@/lib/supabase/server'; // Use if specific admin tasks require service_role
...
// const supabase = await getServerClient(); // Or adminClient if RLS bypass needed for some stats

...
import { Avatar, AvatarFallback, AvatarImage } from "@99packages/ui/components/avatar";
...
export function UserNav({ user }: UserNavProps) {
    ...
    const getInitials = (name?: string | null) => {
        ...
        if (names && names[0] && names[0][0] && names.length > 1 && names[names.length - 1] && names[names.length - 1]?.[0]) {
